  ...
  describe 'GET #index' do 
    ...
    it "includes the location for messages with locations" do
      ...
      expect( JSON.parse(response.body) ).to eq [
        {"id"=>1, "content"=>"some_content", "user_id"=>nil, "chat_id"=>1, "created_at"=>"2013-06-29T22:23:58Z", "updated_at"=>"2013-06-29T22:23:58Z"}, 
        {"id"=>2, "content"=>"some content", "user_id"=>nil, "chat_id"=>1, "created_at"=>"2013-06-29T22:23:58Z", "updated_at"=>"2013-06-29T22:23:58Z", 
          "location"=>{"id"=>1, "message_id"=>2, "latitude"=>"39.733482200000005", "longitude"=>"-104.9926124", "accuracy"=>"2", "address"=>"1060 North Speer Boulevard, Denver, CO 80204, USA", "map_url"=>"http://maps.google.com/maps/api/staticmap?size=700x200&zoom=16&sensor=true&maptype=road&markers=color%3Ablue%7Clabel%3AYou%7C39.733482200000005,-104.9926124", "created_at"=>"2013-06-29T22:23:58Z", "updated_at"=>"2013-06-29T22:23:58Z"} }, 
        {"id"=>3, "content"=>"photo... ", "user_id"=>nil, "chat_id"=>1, "created_at"=>"2013-06-29T22:23:58Z", "updated_at"=>"2013-06-29T22:23:58Z", "photo"=>{"id"=>1, "photo_url"=>"http://filepicker.com/poop", "message_id"=>3, "created_at"=>"2013-06-29T22:23:58Z", "updated_at"=>"2013-06-29T22:23:58Z"}}]
    end
  end
end
